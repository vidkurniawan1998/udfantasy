...
$connection = mysqli_connect('localhost', 'root', '', 'ud_fantasy'); //$connection = mysqli_connect('159.65.132.116', 'bayu', 'B4yU(*#!3431Sdf', 'ud_fantasy');
//$connection = mysqli_connect('localhost', 'fantasyonline_main_user', 'Z*!tX]d^d,%D', 'fantasyonline_db_front');
$product_category = mysqli_query($connection,
...
$product_sub_category = mysqli_query($connection,
    "SELECT products.id, products.title, products.slug, products_category.slug AS category_slug, 
...
$category = mysqli_query($connection,
    "SELECT products_category.slug as category_slug
            FROM products_category");

$sub_category = mysqli_query($connection,
